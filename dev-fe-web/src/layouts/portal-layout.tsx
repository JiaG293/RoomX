  ...
  <header className="fixed top-0 left-0 right-0 h-16 bg-[#2b4dab] dark:bg-[#1e3a8a] shadow-md flex items-center justify-between px-6 z-10 border-b border-[#1E40AF] font-poppins text-white">
    ...
    <div className="flex items-center space-x-4">
      <button
        ...
        className="bg-transparent relative p-2 rounded-full hover:bg-blue-700/30 dark:hover:bg-blue-800/40 transition"
      >
      ...
      {showNotifications && (
        <div className="absolute right-56 top-14 w-80 bg-white dark:bg-gray-900 text-black dark:text-gray-100 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 z-50">
          <div className="p-4 border-b font-semibold text-base text-gray-700 dark:text-white dark:bg-gray-800 bg-gray-100">
            Thông báo
          </div>
          <ul className="max-h-64 overflow-y-auto">
            {fakeNotifications.map((notif) => (
              <li
                key={notif.id}
                className="px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-800 text-sm border-b dark:border-gray-700"
              >
          ...
          <button
            className="w-full py-3 text-center text-blue-600 dark:text-blue-400 text-sm hover:underline bg-gray-50 dark:bg-gray-800"
