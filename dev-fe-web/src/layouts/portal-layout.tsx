...
const CustomHeader = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white bg-opacity-80 backdrop-blur-lg shadow-md flex items-center justify-between px-6 z-10 border-b border-blue-300 font-poppins">
