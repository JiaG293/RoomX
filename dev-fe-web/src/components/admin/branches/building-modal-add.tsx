...
interface AddBuildingModalProps {
  ...
  onSubmit: (buildingData: { code: string; branchId: string }) => void;
}
      ...
      <DialogContent className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-zinc-200 dark:border-zinc-700 p-6">
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button
            ...
            disabled={!branchId || !code.trim()}
            className="bg-blue-600 text-white hover:bg-blue-700 dark:hover:bg-blue-500 disabled:opacity-50"
          >
