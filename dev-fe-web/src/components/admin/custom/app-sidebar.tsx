...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
    <Sidebar
      className="bg-[#1e293b] dark:bg-[#0f172a] border-r border-[#1e3a8a] dark:border-[#1e293b]"
      collapsible="icon"
      {...props}
    >
      <SidebarHeader className="bg-[#1e293b] dark:bg-[#0f172a] border-r border-[#1e3a8a] dark:border-[#1e293b]">
        <TeamSwitcher />
      </SidebarHeader>
      <SidebarContent className="bg-[#1e293b] dark:bg-[#0f172a] border-r border-[#1e3a8a] dark:border-[#1e293b]">
