package com.roomx.infrastructure.keycloak.repository;

import com.roomx.domain.model.UserDomain;
import com.roomx.domain.repository.UserDomainRepository;
import com.roomx.infrastructure.keycloak.mapper.UserRepresentationMapper;
...
@Repository
public class UserRepresentationRepository implements UserDomainRepository {

    Keycloak keycloak;
    UserRepresentationMapper userRepresentationMapper;

    @Override
    public Optional<UserDomain> findById(String realm, String id) {
        try {
